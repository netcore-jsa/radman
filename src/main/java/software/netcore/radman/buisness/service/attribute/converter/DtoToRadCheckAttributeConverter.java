 ...
 * @since v. 1.0.0
 */
public class DtoToRadCheckAttributeConverter implements DtoConverter<AuthenticationDto, RadCheckAttribute> {

    @Override
    public RadCheckAttribute convert(AuthenticationDto source) {
